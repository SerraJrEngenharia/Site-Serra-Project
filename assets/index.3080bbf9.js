...
`,A_=()=>Y(Un,{children:[w(pv,{color:Ii.Color.orange,image:j_,text:"Engenharia da Computa\xE7\xE3o"}),w(M_,{}),w(D_,{}),w(hv,{color:Ii.Color.orange}),w(fv,{carouselData:w_.computingProjects}),w(z_,{onClick:()=>window.scrollTo(0,0),src:mv,alt:"ScrollUp"})]}),Kf=({type:e})=>w(Un,{children:e==="mech"?w(v_,{}):w(A_,{})});function N_(){return w("div",{className:"App",children:Y(cy,{basename:"/Site-Serra",children:[w(Mw,{}),Y(ly,{children:[w(Yn,{path:"/",element:w(W1,{})}),w(Yn,{path:"/computacao",element:w(Kf,{type:"comp"})}),w(Yn,{path:"/mecanica",element:w(Kf,{type:"mech"})}),w(Yn,{path:"/quemSomos",element:w(gE,{})}),w(Yn,{path:"/contatos",element:w(ok,{})})]}),w(Zw,{})]})})}ls.createRoot(document.getElementById("root")).render(w(Rr.StrictMode,{children:w(N_,{})}));
