...
`,Tw=({status:e})=>(console.log(e),Y(Pw,{children:[w(Bl,{active:e,type:"first-line"}),w(Bl,{active:e,type:"mid-line"}),w(Bl,{active:e,type:"last-line"})]})),$w=$.img`
    width: 12rem;
    margin-left: 25%;
...
`,Mw=$.div`
    margin-right: 7%;
`,jw=()=>{const[e,t]=K.exports.useState(!1);return Y(Lw,{children:[w(Ct,{to:"/",children:w($w,{src:py,alt:"Logo Serra Jr"})}),w(Mw,{onClick:()=>{t(!e)},children:w(Tw,{status:e})}),w(_w,{}),w(Ow,{status:e,toogle:t})]})},Rw=$.div`
	margin: 0;   
`,Dw=$.a`
...
`,ve=({image:e,altText:t,redirect:n})=>w(Rw,{children:w(Dw,{href:n,target:"_blank",rel:"noopener noreferrer",children:w(zw,{src:e,alt:t})})}),Vr="/assets/voitto.e51ea618.svg",Qr="/assets/iprj.03355e19.svg",Gr="/assets/inovafri.c4b07fe0.svg",Yr="/assets/wiseup.d9d06fa3.svg",Xr="/assets/ligajr.52feeabf.svg",Aw=$.div`
    background: #D9D9D9;
...
`,n1=()=>w(t1,{children:w(e1,{onInit:e=>{e.typeString("Engrenando ideias, inovando o mercado.").pauseFor(2e3).deleteAll().start()},options:{wrapperClassName:"writer",cursorClassName:"writer-cursor",loop:!0}})}),r1="/assets/presentation-image.b69cdd6e.svg",i1=$.div`
...
`,l1=()=>Y(i1,{children:[w(a1,{children:w(n1,{})}),w(o1,{src:r1,alt:"apresenta\xE7\xE3o"})]}),s1=$.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`,d1=({icon:e,text:t,alt:n})=>Y(s1,{children:[w(u1,{src:e,alt:n}),w(c1,{children:t})]}),f1=$.div`
  margin: 2% 1% 2% 1%;
...
`,vf=({title:e,buttonUrl:t,buttonTitle:n,color:r,images:i,texts:o})=>{const l=Ga();return Y(f1,{children:[w(p1,{titleColor:r,children:e}),Y(h1,{children:[w(m1,{children:i.map((a,s)=>w(d1,{icon:a,text:o[s],alt:o[s]},s))}),w(v1,{onClick:()=>{l(t),window.scrollTo(0,0)},buttonColor:r,children:n})]})]})},g1="/assets/Sites.a0112d0d.svg",y1="/assets/sistemas-web.d1b27032.svg",w1="/assets/manutencao.33f9dd1a.svg",x1="/assets/desenho-tecnico.22fbb0fb.svg",S1="/assets/braco-robo.2b026e48.svg",E1="/assets/impressora-3d.75613d7d.svg",k1="/assets/membros-2.457898e5.svg",b1=$.p`
...
`,O1=$.div`
    ...
    justify-content: center;
    flex-direction: column;
`,Lc=({text:e,fontSize:t,titleWidth:n})=>w(C1,{children:Y(O1,{children:[w(b1,{style:{fontSize:t},children:e}),w(_1,{gradientWidth:n})]})}),P1=$.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`,A1=({title:e,color:t,text:n,image:r})=>{const i=Ga();return Y(P1,{children:[w(T1,{titleColor:t,children:e}),Y($1,{children:[Y(L1,{children:[w(M1,{children:w(j1,{children:n})}),w(R1,{src:r,alt:"Imagem com os membros da Serra Jr. Engenharia"})]}),w(D1,{children:w(z1,{onClick:()=>{i("/quemsomos"),window.scrollTo(0,0)},buttonColor:t,children:"Saiba Mais"})})]})]})},N1="/assets/background-image.668c0125.svg",I1=$.div`
  display: flex;
  flex-direction: row;
  flex-wrap: wrap;
  justify-content: center;
...
`,nE=e=>{const t={dots:!0,infinite:!0,speed:1e3,slidesToShow:1,slidesToScroll:1,arrows:!1,autoplay:!0,autoplaySpeed:2500};return w(tE,{containerWidth:e.width,children:w(Ic,{...t,children:e.carouselData.map((n,r)=>w(JS,{children:w(ZS,{children:w(eE,{src:n,alt:e.alt})})},r))})})},rE=$.div`
    width: 100%;
    height: 6rem;
    min-height: 30px;
    background-color: ${({titleColor:e})=>e!=null?e:"#FD6300"};
...
`,uE=({title:e,color:t})=>Y(aE,{children:[w(rE,{titleColor:t,children:e}),w(iE,{children:Y(oE,{children:[w(sE,{children:w(lE,{children:Te.membersText})}),w(nE,{width:"50%",carouselData:Te.members,alt:"Imagens dos membros da Serra Jr. Engenharia"})]})})]}),cE=$.div``,dE=$.div`
    display: flex;
    justify-content: center;
...
`,fE=()=>Y(cE,{children:[Y(dE,{children:[w(Yl,{image:Te.icons[0].image,imageAlt:Te.icons[0].imageAlt,list:Te.icons[0].list,hasList:Te.icons[0].hasList,content:Te.icons[0].content,titleText:Te.icons[0].titleText}),w(Af,{}),w(Yl,{image:Te.icons[1].image,imageAlt:Te.icons[1].imageAlt,list:Te.icons[1].list,hasList:Te.icons[1].hasList,content:Te.icons[1].content,titleText:Te.icons[1].titleText}),w(Af,{}),w(Yl,{image:Te.icons[2].image,imageAlt:Te.icons[2].imageAlt,list:Te.icons[2].list,hasList:Te.icons[2].hasList,content:Te.icons[2].content,titleText:Te.icons[2].titleText})]}),w(uE,{title:"Quem Somos",color:"#001830"})]}),pE=$.div`
...
`,gE=()=>Y(Hn,{children:[w(hE,{children:Y(pE,{children:[w(mE,{children:"Sobre N\xF3s"}),w(vE,{src:B1,alt:"imagem sobre n\xF3s"})]})}),w(fE,{})]}),yE=$.div`
    width: 100%;
    height: 100%;
    display: flex;
    justify-content: center;
...
`,ik=$.div`  
    ...
    align-items: center;
    width: 90%;
`,ok=()=>{const[e,t]=K.exports.useState(""),[n,r]=K.exports.useState(""),[i,o]=K.exports.useState(""),[l,a]=K.exports.useState(""),[s,u]=K.exports.useState(""),[d,c]=K.exports.useState(""),f=m=>{c(m)},h=m=>{if(m.preventDefault(),e===""||n===""||i===""||l===""||s===""||d===""){alert("Preencha todos os campos");return}const y={from_name:e,message:s,from_email:n,from_phone:i,subject:l,"g-recaptcha-response":d};PE.send("service_al540kd","template_4eqf2kl",y,"HRfoO7P69RR47ZQ0c").then(k=>{alert("Email enviado"),t(""),r(""),o(""),a(""),u("")},k=>{alert("Aconteceu um erro"),console.log("Erro: ",k)})};return Y(rk,{children:[w(Lc,{titleWidth:"40%",text:"Entre em contato conosco!"}),Y(XE,{children:[Y(QE,{children:[Y(_o,{children:[w(bo,{src:qE,alt:""}),w(ko,{children:"Rua Bonfim n\xB025 - Vila Amelia, Nova Friburgo - RJ, 28625-570"})]}),Y(_o,{children:[w(bo,{src:VE,alt:""}),w(ko,{children:"(22) 2533-2265"})]}),Y(_o,{children:[w(bo,{src:BE,alt:""}),w(ko,{children:"serrajr@iprj.uerj.br"})]}),Y(_o,{children:[w(bo,{src:WE,alt:""}),Y(ko,{children:["Hor\xE1rio de atendimento: ",w("br",{}),"Segunda a Sexta, das 09hrs ",w("br",{}),"\xE0s 17hrs."]})]})]}),w(nk,{children:w(KE,{children:Y(JE,{children:[w(Kr,{children:"Nome"}),w(Co,{type:"text",placeholder:"Insira seu nome",value:e,onChange:m=>t(m.target.value)}),w(Kr,{children:"Email"}),w(Co,{type:"text",placeholder:"Insira seu email",value:n,onChange:m=>r(m.target.value)}),w(Kr,{children:"Telefone"}),w(Co,{type:"text",placeholder:"(XX) XXXXX-XXXX",value:i,onChange:m=>o(m.target.value)}),w(Kr,{children:"Assunto"}),w(Co,{type:"text",placeholder:"Digite o assunto",value:l,onChange:m=>a(m.target.value)}),w(Kr,{children:"Mensagem"}),w(tk,{type:"text",placeholder:"Digite a mensagem",value:s,onChange:m=>u(m.target.value)}),w(ik,{children:w(UE,{sitekey:"6LftIRYjAAAAABYVGiNblWwK1r4oIrUQJ0Lr_EUq",onChange:f})}),w(ek,{children:w(ZE,{onClick:m=>h(m),children:"Enviar"})})]})})})]}),w(YE,{children:w(GE,{children:w(kE,{})})})]})};var ku={exports:{}},Un={},bu={exports:{}},Lt={},Ca={exports:{}};(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.default=d;/*!
...
`,fv=e=>{const t={dots:!1,infinite:!0,speed:500,slidesToShow:1,slidesToScroll:1,arrows:!0},[n,r]=K.exports.useState(!1),[i,o]=K.exports.useState();return w(Ic,{...t,children:e.carouselData.map((l,a)=>w(_b,{children:w(Cb,{children:Y(Ob,{children:[w(Pb,{children:w(Lc,{text:l.title})}),Y(Tb,{children:[w(Lb,{children:w($b,{src:l.image[0],alt:l.title})}),Y(Rb,{children:[w(Mb,{children:l.content}),w(jb,{onClick:()=>{r(!n),o(l)},children:"Saiba Mais"}),w(bb,{data:i,status:n,setStatus:r})]})]})]})})},a))})},Db=$.div`
...
`,pv=({image:e,text:t,color:n})=>Y(Db,{style:{backgroundColor:n},children:[w(zb,{children:t?t.split(" ").map((r,i)=>w(Ab,{children:r},i)):null}),w(Nb,{src:e,alt:t})]}),Ib=$.div`
    margin-top: 3%;
    margin-bottom: 3%;
...
`,cr=({icon:e,title:t,text:n,arrow:r})=>Y(Ib,{children:[Y(Fb,{children:[w(Gf,{src:e,alt:t}),w(Hb,{children:t})]}),Y(Ub,{children:[w(Gf,{src:r,alt:"Seta"}),w(Wb,{children:n})]})]}),Bb="/assets/hammer-icon.c370caae.svg",qb="/assets/bot-icon.237c34bd.svg",Vb="/assets/3d-icon.6c010241.svg",Qb="/assets/drawing-icon.462650d6.svg",Po="/assets/seta.7067b273.svg",Gb="/assets/background-mecanica.81e45f94.svg",Yb=$.div`
...
`,v_=()=>Y(Hn,{children:[w(pv,{color:Ii.Color.lightBlue,image:p_,text:"Engenharia Mec\xE2nica"}),w(Kb,{}),w(h_,{}),w(hv,{color:Ii.Color.lightBlue}),w(fv,{carouselData:f_.mechanicsProjects}),w(m_,{onClick:()=>window.scrollTo(0,0),src:mv,alt:"ScrollUp"})]}),g_="/assets/friburguense.ba8886f5.svg",y_="/assets/projeto-tmf.f6316197.svg",w_={computingProjects:[{title:"Projeto Friburguense",image:[g_],imageSize:"30vh",content:`O projeto consistiu no desenvolvimento de um Website voltado \xE0 aquisi\xE7\xE3o de planos 
...
`,A_=()=>Y(Hn,{children:[w(pv,{color:Ii.Color.orange,image:R_,text:"Engenharia da Computa\xE7\xE3o"}),w(j_,{}),w(D_,{}),w(hv,{color:Ii.Color.orange}),w(fv,{carouselData:w_.computingProjects}),w(z_,{onClick:()=>window.scrollTo(0,0),src:mv,alt:"ScrollUp"})]}),Kf=({type:e})=>w(Hn,{children:e==="mech"?w(v_,{}):w(A_,{})});function N_(){return w("div",{className:"App",children:Y(cy,{basename:"/",children:[w(jw,{}),Y(ly,{children:[w(Yn,{path:"/",element:w(W1,{})}),w(Yn,{path:"/computacao",element:w(Kf,{type:"comp"})}),w(Yn,{path:"/mecanica",element:w(Kf,{type:"mech"})}),w(Yn,{path:"/quemSomos",element:w(gE,{})}),w(Yn,{path:"/contatos",element:w(ok,{})})]}),w(Zw,{})]})})}ls.createRoot(document.getElementById("root")).render(w(Lr.StrictMode,{children:w(N_,{})}));
