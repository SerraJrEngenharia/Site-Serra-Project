...
`}}}return o}(this)},e}(),Sy=/(a)(d)/gi,uf=function(e){return String.fromCharCode(e+(e>25?39:97))};function ou(e){var t,n="";for(t=Math.abs(e);t>52;t=t/52|0)n=uf(t%52)+n;return(uf(t%52)+n).replace(Sy,"$1-$2")}var sr=function(e,t){for(var n=t.length;n;)e=33*e^t.charCodeAt(--n);return e},Em=function(e){return sr(5381,e)};function ky(e){for(var t=0;t<e.length;t+=1){var n=e[t];if(Ri(n)&&!Mc(n))return!1}return!0}var Ey=Em("5.3.5"),by=function(){function e(t,n,r){this.rules=t,this.staticRulesId="",this.isStatic=(r===void 0||r.isStatic)&&ky(t),this.componentId=n,this.baseHash=sr(Ey,n),this.baseStyle=r,km.registerId(n)}return e.prototype.generateAndInjectStyles=function(t,n,r){var i=this.componentId,o=[];if(this.baseStyle&&o.push(this.baseStyle.generateAndInjectStyles(t,n,r)),this.isStatic&&!r.hash)if(this.staticRulesId&&n.hasNameForId(i,this.staticRulesId))o.push(this.staticRulesId);else{var l=_r(this.rules,t,n,r).join(""),a=ou(sr(this.baseHash,l)>>>0);if(!n.hasNameForId(i,a)){var s=r(l,"."+a,void 0,i);n.insertRules(i,a,s)}o.push(a),this.staticRulesId=a}else{for(var u=this.rules.length,d=sr(this.baseHash,r.hash),c="",f=0;f<u;f++){var h=this.rules[f];if(typeof h=="string")c+=h;else if(h){var m=_r(h,t,n,r),y=Array.isArray(m)?m.join(""):m;d=sr(d,y+f),c+=y}}if(c){var k=ou(d>>>0);if(!n.hasNameForId(i,k)){var v=r(c,"."+k,void 0,i);n.insertRules(i,k,v)}o.push(k)}}return o.join(" ")},e}(),_y=/^\s*\/\/.*$/gm,Cy=[":","[",".","#"];function Oy(e){var t,n,r,i,o=e===void 0?yn:e,l=o.options,a=l===void 0?yn:l,s=o.plugins,u=s===void 0?va:s,d=new K0(a),c=[],f=function(y){function k(v){if(v)try{y(v+"}")}catch{}}return function(v,p,g,x,O,P,E,S,M,j){switch(v){case 1:if(M===0&&p.charCodeAt(0)===64)return y(p+";"),"";break;case 2:if(S===0)return p+"/*|*/";break;case 3:switch(S){case 102:case 112:return y(g[0]+p),"";default:return p+(j===0?"/*|*/":"")}case-2:p.split("/*|*/}").forEach(k)}}}(function(y){c.push(y)}),h=function(y,k,v){return k===0&&Cy.indexOf(v[n.length])!==-1||v.match(i)?y:"."+t};function m(y,k,v,p){p===void 0&&(p="&");var g=y.replace(_y,""),x=k&&v?v+" "+k+" { "+g+" }":g;return t=p,n=k,r=new RegExp("\\"+n+"\\b","g"),i=new RegExp("(\\"+n+"\\b){2,}"),d(v||!k?"":k,x)}return d.use([].concat(u,[function(y,k,v){y===2&&v.length&&v[0].lastIndexOf(n)>0&&(v[0]=v[0].replace(r,h))},f,function(y){if(y===-2){var k=c;return c=[],k}}])),m.hash=u.length?u.reduce(function(y,k){return k.name||Wi(15),sr(y,k.name)},5381).toString():"",m}var bm=Lr.createContext();bm.Consumer;var _m=Lr.createContext(),Py=(_m.Consumer,new km),au=Oy();function Ty(){return K.exports.useContext(bm)||Py}function Ly(){return K.exports.useContext(_m)||au}var My=function(){function e(t,n){var r=this;this.inject=function(i,o){o===void 0&&(o=au);var l=r.name+o.hash;i.hasNameForId(r.id,l)||i.insertRules(r.id,l,o(r.rules,l,"@keyframes"))},this.toString=function(){return Wi(12,String(r.name))},this.name=t,this.id="sc-keyframes-"+t,this.rules=n}return e.prototype.getName=function(t){return t===void 0&&(t=au),this.name+t.hash},e}(),Ry=/([A-Z])/,jy=/([A-Z])/g,zy=/^ms-/,Dy=function(e){return"-"+e.toLowerCase()};function cf(e){return Ry.test(e)?e.replace(jy,Dy).replace(zy,"-ms-"):e}var df=function(e){return e==null||e===!1||e===""};function _r(e,t,n,r){if(Array.isArray(e)){for(var i,o=[],l=0,a=e.length;l<a;l+=1)(i=_r(e[l],t,n,r))!==""&&(Array.isArray(i)?o.push.apply(o,i):o.push(i));return o}if(df(e))return"";if(Mc(e))return"."+e.styledComponentId;if(Ri(e)){if(typeof(u=e)!="function"||u.prototype&&u.prototype.isReactComponent||!t)return e;var s=e(t);return _r(s,t,n,r)}var u;return e instanceof My?n?(e.inject(n,r),e.getName(r)):e:iu(e)?function d(c,f){var h,m,y=[];for(var k in c)c.hasOwnProperty(k)&&!df(c[k])&&(Array.isArray(c[k])&&c[k].isCss||Ri(c[k])?y.push(cf(k)+":",c[k],";"):iu(c[k])?y.push.apply(y,d(c[k],k)):y.push(cf(k)+": "+(h=k,(m=c[k])==null||typeof m=="boolean"||m===""?"":typeof m!="number"||m===0||h in J0?String(m).trim():m+"px")+";"));return f?[f+" {"].concat(y,["}"]):y}(e):e.toString()}var ff=function(e){return Array.isArray(e)&&(e.isCss=!0),e};function $y(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];return Ri(e)||iu(e)?ff(_r(af(va,[e].concat(n)))):n.length===0&&e.length===1&&typeof e[0]=="string"?e:ff(_r(af(e,n)))}var Ay=function(e,t,n){return n===void 0&&(n=yn),e.theme!==n.theme&&e.theme||t||n.theme},Ny=/[!"#$%&'()*+,./:;<=>?@[\\\]^`{|}~-]+/g,Iy=/(^-|-$)/g;function Vl(e){return e.replace(Ny,"-").replace(Iy,"")}var Fy=function(e){return ou(Em(e)>>>0)};function mo(e){return typeof e=="string"&&!0}var lu=function(e){return typeof e=="function"||typeof e=="object"&&e!==null&&!Array.isArray(e)},Hy=function(e){return e!=="__proto__"&&e!=="constructor"&&e!=="prototype"};function Uy(e,t,n){var r=e[n];lu(t)&&lu(r)?Cm(r,t):e[n]=t}function Cm(e){for(var t=arguments.length,n=new Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];for(var i=0,o=n;i<o.length;i++){var l=o[i];if(lu(l))for(var a in l)Hy(a)&&Uy(e,l[a],a)}return e}var Om=Lr.createContext();Om.Consumer;var Ql={};function Pm(e,t,n){var r=Mc(e),i=!mo(e),o=t.attrs,l=o===void 0?va:o,a=t.componentId,s=a===void 0?function(p,g){var x=typeof p!="string"?"sc":Vl(p);Ql[x]=(Ql[x]||0)+1;var O=x+"-"+Fy("5.3.5"+x+Ql[x]);return g?g+"-"+O:O}(t.displayName,t.parentComponentId):a,u=t.displayName,d=u===void 0?function(p){return mo(p)?"styled."+p:"Styled("+lf(p)+")"}(e):u,c=t.displayName&&t.componentId?Vl(t.displayName)+"-"+t.componentId:t.componentId||s,f=r&&e.attrs?Array.prototype.concat(e.attrs,l).filter(Boolean):l,h=t.shouldForwardProp;r&&e.shouldForwardProp&&(h=t.shouldForwardProp?function(p,g,x){return e.shouldForwardProp(p,g,x)&&t.shouldForwardProp(p,g,x)}:e.shouldForwardProp);var m,y=new by(n,c,r?e.componentStyle:void 0),k=y.isStatic&&l.length===0,v=function(p,g){return function(x,O,P,E){var S=x.attrs,M=x.componentStyle,j=x.defaultProps,D=x.foldedComponentIds,A=x.shouldForwardProp,$=x.styledComponentId,N=x.target,I=function(F,L,J){F===void 0&&(F=yn);var W=Vt({},L,{theme:F}),ee={};return J.forEach(function(ie){var se,ne,Oe,Ne=ie;for(se in Ri(Ne)&&(Ne=Ne(W)),Ne)W[se]=ee[se]=se==="className"?(ne=ee[se],Oe=Ne[se],ne&&Oe?ne+" "+Oe:ne||Oe):Ne[se]}),[W,ee]}(Ay(O,K.exports.useContext(Om),j)||yn,O,S),G=I[0],R=I[1],T=function(F,L,J,W){var ee=Ty(),ie=Ly(),se=L?F.generateAndInjectStyles(yn,ee,ie):F.generateAndInjectStyles(J,ee,ie);return se}(M,E,G),z=P,U=R.$as||O.$as||R.as||O.as||N,V=mo(U),H=R!==O?Vt({},O,{},R):O,b={};for(var q in H)q[0]!=="$"&&q!=="as"&&(q==="forwardedAs"?b.as=H[q]:(A?A(q,tf,U):!V||tf(q))&&(b[q]=H[q]));return O.style&&R.style!==O.style&&(b.style=Vt({},O.style,{},R.style)),b.className=Array.prototype.concat(D,$,T!==$?T:null,O.className,R.className).filter(Boolean).join(" "),b.ref=z,K.exports.createElement(U,b)}(m,p,g,k)};return v.displayName=d,(m=Lr.forwardRef(v)).attrs=f,m.componentStyle=y,m.displayName=d,m.shouldForwardProp=h,m.foldedComponentIds=r?Array.prototype.concat(e.foldedComponentIds,e.styledComponentId):va,m.styledComponentId=c,m.target=r?e.target:e,m.withComponent=function(p){var g=t.componentId,x=function(P,E){if(P==null)return{};var S,M,j={},D=Object.keys(P);for(M=0;M<D.length;M++)S=D[M],E.indexOf(S)>=0||(j[S]=P[S]);return j}(t,["componentId"]),O=g&&g+"-"+(mo(p)?p:Vl(lf(p)));return Pm(p,Vt({},x,{attrs:f,componentId:O}),n)},Object.defineProperty(m,"defaultProps",{get:function(){return this._foldedDefaultProps},set:function(p){this._foldedDefaultProps=r?Cm({},e.defaultProps,p):p}}),m.toString=function(){return"."+m.styledComponentId},i&&xm(m,e,{attrs:!0,componentStyle:!0,displayName:!0,foldedComponentIds:!0,shouldForwardProp:!0,styledComponentId:!0,target:!0,withComponent:!0}),m}var su=function(e){return function t(n,r,i){if(i===void 0&&(i=yn),!Xa.exports.isValidElementType(r))return Wi(1,String(r));var o=function(){return n(r,i,$y.apply(void 0,arguments))};return o.withConfig=function(l){return t(n,r,Vt({},i,{},l))},o.attrs=function(l){return t(n,r,Vt({},i,{attrs:Array.prototype.concat(i.attrs,l).filter(Boolean)}))},o}(Pm,e)};["a","abbr","address","area","article","aside","audio","b","base","bdi","bdo","big","blockquote","body","br","button","canvas","caption","cite","code","col","colgroup","data","datalist","dd","del","details","dfn","dialog","div","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","iframe","img","input","ins","kbd","keygen","label","legend","li","link","main","map","mark","marquee","menu","menuitem","meta","meter","nav","noscript","object","ol","optgroup","option","output","p","param","picture","pre","progress","q","rp","rt","ruby","s","samp","script","section","select","small","source","span","strong","style","sub","summary","sup","table","tbody","td","textarea","tfoot","th","thead","time","title","tr","track","u","ul","var","video","wbr","circle","clipPath","defs","ellipse","foreignObject","g","image","line","linearGradient","marker","mask","path","pattern","polygon","polyline","radialGradient","rect","stop","svg","text","textPath","tspan"].forEach(function(e){su[e]=su(e)});const C=su,_={mobile:"390px",largeMobile:"500px",tablet:"820px",notebook:"1024px",largeNotebook:"1440px",desktop:"1920px",largeDesktop:"2560px",extraLargeDesktop:"3840px"},Wy=C.div`
	margin: 0;   
`,By=C.a`
...
`,nw=()=>{const[e,t]=K.exports.useState(!1);return w(tw,{children:Q(Y1,{children:[w(go,{children:w(Ct,{to:"/",children:"Home"})}),w(go,{children:w(Ct,{to:"/quemSomos",children:"Sobre N\xF3s"})}),w(go,{children:Q(K1,{onClick:()=>t(!e),children:[Q(Z1,{children:[w(X1,{children:"Servi\xE7os"}),w(J1,{activeStyle:e,src:v1,alt:"Seta"})]}),Q(ew,{activeStyle:e,children:[w(yf,{children:w(Ct,{to:"/computacao",children:"Computa\xE7\xE3o"})}),w(yf,{children:w(Ct,{to:"/mecanica",children:"Mec\xE2nica"})})]})]})}),w(go,{children:w(Ct,{to:"/contatos",children:"Contato"})})]})})},Yr=C.div`
    display: flex;
    justify-content: center;
    align-items: center;
    font-size: 1.4rem;
...
`,iw=({status:e,toogle:t})=>Q(rw,{activeStyle:e,children:[w(Yr,{children:w(Ct,{onClick:()=>t(!e),to:"/",children:"Home"})}),w(Yr,{children:w(Ct,{onClick:()=>t(!e),to:"/quemSomos",children:"Sobre N\xF3s"})}),w(Yr,{children:w(Ct,{onClick:()=>t(!e),to:"/computacao",children:"Computa\xE7\xE3o"})}),w(Yr,{children:w(Ct,{onClick:()=>t(!e),to:"/mecanica",children:"Mec\xE2nica"})}),w(Yr,{children:w(Ct,{onClick:()=>t(!e),to:"/contatos",children:"Contatos"})})]}),Kl=C.div`
    height: 3px;
    background-color: #fff;
    width: 30px;
    margin: 3px;
...
`,rE=C.div`  
    ...
    align-items: center;
    width: 90%;
`,iE=()=>{const[e,t]=K.exports.useState(""),[n,r]=K.exports.useState(""),[i,o]=K.exports.useState(""),[l,a]=K.exports.useState(""),[s,u]=K.exports.useState(""),[d,c]=K.exports.useState(""),f=m=>{c(m)},h=m=>{if(m.preventDefault(),e===""||n===""||i===""||l===""||s===""||d===""){alert("Preencha todos os campos");return}const y={from_name:e,message:s,from_email:n,from_phone:i,subject:l,"g-recaptcha-response":d};Ok.send("service_al540kd","template_4eqf2kl",y,"HRfoO7P69RR47ZQ0c").then(k=>{alert("Email enviado"),t(""),r(""),o(""),a(""),u("")},k=>{alert("Aconteceu um erro"),console.log("Erro: ",k)})};return Q(nE,{children:[w($c,{titleWidth:"40%",text:"Entre em contato conosco!"}),Q(Yk,{children:[Q(Qk,{children:[Q(Eo,{children:[w(ko,{src:Bk,alt:""}),w(So,{children:"Rua Bonfim n\xB025 - Vila Amelia, Nova Friburgo - RJ, 28625-570"})]}),Q(Eo,{children:[w(ko,{src:Vk,alt:""}),w(So,{children:"(22) 2533-2265"})]}),Q(Eo,{children:[w(ko,{src:Wk,alt:""}),w(So,{children:"serrajr@iprj.uerj.br"})]}),Q(Eo,{children:[w(ko,{src:Uk,alt:""}),Q(So,{children:["Hor\xE1rio de atendimento: ",w("br",{}),"Segunda a Sexta, das 09hrs ",w("br",{}),"\xE0s 17hrs."]})]})]}),w(tE,{children:w(Xk,{children:Q(Kk,{children:[w(Xr,{children:"Nome"}),w(bo,{type:"text",placeholder:"Insira seu nome",value:e,onChange:m=>t(m.target.value)}),w(Xr,{children:"Email"}),w(bo,{type:"text",placeholder:"Insira seu email",value:n,onChange:m=>r(m.target.value)}),w(Xr,{children:"Telefone"}),w(bo,{type:"text",placeholder:"(XX) XXXXX-XXXX",value:i,onChange:m=>o(m.target.value)}),w(Xr,{children:"Assunto"}),w(bo,{type:"text",placeholder:"Digite o assunto",value:l,onChange:m=>a(m.target.value)}),w(Xr,{children:"Mensagem"}),w(eE,{type:"text",placeholder:"Digite a mensagem",value:s,onChange:m=>u(m.target.value)}),w(rE,{children:w(Hk,{sitekey:"6LftIRYjAAAAABYVGiNblWwK1r4oIrUQJ0Lr_EUq",onChange:f})}),w(Zk,{children:w(Jk,{onClick:m=>h(m),children:"Enviar"})})]})})})]}),w(Gk,{children:w(qk,{children:w(kk,{})})})]})};var Ou={exports:{}},Un={},Pu={exports:{}},Mt={},La={exports:{}};(function(e,t){Object.defineProperty(t,"__esModule",{value:!0}),t.default=d;/*!
