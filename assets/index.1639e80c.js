...
`,v_=()=>Y(Hn,{children:[w(pv,{color:Or.Color.lightBlue,image:p_,text:"Engenharia Mec\xE2nica"}),w(Kb,{}),w(h_,{}),w(hv,{color:Or.Color.lightBlue}),w(fv,{carouselData:f_.mechanicsProjects}),w(m_,{onClick:()=>window.scrollTo(0,0),src:mv,alt:"ScrollUp"})]}),g_="/Site-Serra/assets/friburguense.ba8886f5.svg",y_="/Site-Serra/assets/projeto-tmf.f6316197.svg",w_={computingProjects:[{title:"Projeto Friburguense",image:[g_],imageSize:"30vh",content:`O projeto consistiu no desenvolvimento de um Website voltado \xE0 aquisi\xE7\xE3o de planos 
...
`,A_=()=>Y(Hn,{children:[w(pv,{color:Or.Color.orange,image:R_,text:"Engenharia da Computa\xE7\xE3o"}),w(M_,{}),w(z_,{}),w(hv,{color:Or.Color.orange}),w(fv,{carouselData:w_.computingProjects}),w(D_,{onClick:()=>window.scrollTo(0,0),src:mv,alt:"ScrollUp"})]}),Kf=({type:e})=>w(Hn,{children:e==="mech"?w(v_,{}):w(A_,{})});function N_(){return w("div",{className:"App",children:Y(cy,{basename:"/Site-Serra",children:[w(j1,{}),Y(ly,{children:[w(Yn,{path:"/",element:w(Uw,{})}),w(Yn,{path:"/computacao",element:w(Kf,{type:"comp"})}),w(Yn,{path:"/mecanica",element:w(Kf,{type:"mech"})}),w(Yn,{path:"/quemSomos",element:w(vE,{})}),w(Yn,{path:"/contatos",element:w(ik,{})})]}),w(J1,{})]})})}ls.createRoot(document.getElementById("root")).render(w(jr.StrictMode,{children:w(N_,{})}));
