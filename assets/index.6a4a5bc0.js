...
`,Hl=b.div`
    margin-left: 2rem;
    @media screen and (min-width: ${C.mobile}){
        flex-direction: column;
    }
`,Ul=b.span`
    color: white;
...
`,H1=b.div`
    ...
    @media screen and (min-width: ${C.largeNotebook}){
        width: 10vw;
    }
...
`,B1=b.div`
    ...
    @media screen and (min-width: ${C.notebook}){
        visibility: hidden;
    }   
