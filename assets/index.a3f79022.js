...
`,zb=()=>{const e=Mc();return Q(xb,{children:[Q(kb,{children:[Q(Eb,{children:[w(Gf,{children:"Engenharia"}),w(Gf,{children:"Mec\xE2nica"})]}),w(Cb,{src:hb,alt:"Imagem de Mec\xE2nica"})]}),Q(Sb,{children:[w(bb,{children:"Carta de Servi\xE7os"}),w(_b,{children:"Engenharia Mec\xE2nica"}),Q(Xf,{children:[Q(_o,{children:[Q(Co,{children:[w(Jt,{src:mb,alt:"Imagem Sistemas"}),w(Eo,{children:"Projeto e Manuten\xE7\xE3o de Equipamentos"})]}),Q(Oo,{children:[w(Jt,{src:ko,alt:"Seta"}),w(bo,{children:"Como nosso principal servi\xE7o, desenvolvemos os mais diversos equipamentos para atender cada demanda da melhor maneira. Assim, nosso time ir\xE1 estudar a fundo a necessidade do cliente para ent\xE3o passar por cada fase do projeto, apresentando um estudo minucioso, seu desenho t\xE9cnico, op\xE7\xF5es de prot\xF3tipo e ent\xE3o colocando na pr\xE1tica e suas necess\xE1rias manuten\xE7\xF5es."})]})]}),Q(_o,{children:[Q(Co,{children:[w(Jt,{src:yb,alt:"Imagem Site"}),w(Eo,{children:"Desenho T\xE9cnico e Industrial"})]}),Q(Oo,{children:[w(Jt,{src:ko,alt:"Seta"}),w(bo,{children:"Com aux\xEDlio de programas CAD, a Serra Jr oferece servi\xE7os de desenhos de pe\xE7as e maquin\xE1rios, em 2D e 3D, para dar vida ao conceito proposto pelo cliente seguindo todas as normas necess\xE1rias nesse processo t\xE3o significante de um projeto."})]})]})]}),Q(Xf,{children:[Q(_o,{children:[Q(Co,{children:[w(Jt,{src:vb,alt:"Imagem Sistemas"}),w(Eo,{children:"Projetos de Automa\xE7\xE3o"})]}),Q(Oo,{children:[w(Jt,{src:ko,alt:"Seta"}),w(bo,{children:"A partir da demanda do cliente desenvolvemos projetos para automa\xE7\xE3o e otimiza\xE7\xE3o de tarefas. Tendo em vista que o tempo \xE9 um recurso precioso e precisa ser sempre melhor aproveitado, nosso time ir\xE1 desenvolver o melhor estudo para otimiza\xE7\xE3o do seu projeto al\xE9m de cria\xE7\xE3o de prot\xF3tipos usando microcontroladores, CLP's e outras tecnologias da ind\xFAstria 4.0."})]})]}),Q(_o,{children:[Q(Co,{children:[w(Jt,{src:gb,alt:"Imagem Site"}),w(Eo,{children:"Prototipagem"})]}),Q(Oo,{children:[w(Jt,{src:ko,alt:"Seta"}),w(bo,{children:"A experimenta\xE7\xE3o de ideias iniciais de um projeto \xE9 uma fase muito importante de seu desenvolvimento, e por isso a utiliza\xE7\xE3o de prot\xF3tipos antes do projeto final \xE9 essencial. Na Serra Jr contamos com equipamentos como impressoras 3D e CNC de corte a laser onde nossos membros capacitados podem desenvolver o melhor prot\xF3tipo a baixo custo de seu projeto."})]})]})]})]}),w(Ob,{}),w(Tb,{children:w(Pb,{onClick:()=>e("/contatos"),children:"Quer colocar um projeto em pr\xE1tica? \u2192"})}),w(Lb,{children:w(gv,{carouselData:pb.mechanicsProjects})}),w(Mb,{onClick:()=>window.scrollTo(0,0),src:yv,alt:"ScrollUp"})]})},jb="/Site-Serra/assets/friburguense.ba8886f5.svg",Db="/Site-Serra/assets/projeto-tmf.f6316197.svg",Rb={computingProjects:[{title:"Projeto Friburguense",image:jb,content:`O projeto consistiu no desenvolvimento de um Website voltado \xE0 aquisi\xE7\xE3o de planos 
            ...
            do clube, com um slider para exibi\xE7\xE3o de seus logotipos.`,members:["alguem","alguem","alguem","alguem","alguem","alguem"],opinions:["dskadksoapdka","msakdlmsakdlas","dsaklmsakdlsmadlas","sal\xE7ds,a\xE7lds,al\xE7dsa,\xE7"]},{title:"Projeto TMF",image:Db,content:`O projeto consistiu no desenvolvimento de um website para a TMF Usinagem, para exibi\xE7\xE3o 
            ...
            localiza\xE7\xE3o da mesma.`,members:["alguem","alguem","alguem","alguem","alguem","alguem"],opinions:["dskadksoapdka","msakdlmsakdlas","dsaklmsakdlsmadlas","sal\xE7ds,a\xE7lds,al\xE7dsa,\xE7"],acess:"https://usinagemtmf.com.br/"}]},$b="/Site-Serra/assets/presentation-image.3bba7d23.svg",Ab="/Site-Serra/assets/desenvolvimento-sistemas.85c54f6d.svg",Nb="/Site-Serra/assets/desenvolvimento-sites.cef968a9.svg",Kf="/Site-Serra/assets/seta.13cafa5d.svg",Ib="/Site-Serra/assets/css-icon.e1a4dd78.svg",Fb="/Site-Serra/assets/html-icon.e0dc6b68.svg",Hb="/Site-Serra/assets/js-icon.f4d001af.svg",Ub="/Site-Serra/assets/react-icon.f937629c.svg",Wb="/Site-Serra/assets/ts-icon.bf061be4.svg",Bb="/Site-Serra/assets/styled-icon.35b18102.svg",Vb="/Site-Serra/assets/background-computacao.dbcf66d3.svg",Qb=C.div`
...
`,o_=C.hr`
    ...
    border: 0;
    background: linear-gradient(90deg, rgba(4,173,215,1) 0%, rgba(4,173,215,1) 41%, rgba(255,116,0,1) 69%);
`,a_=()=>{const e=Mc();return Q(Qb,{children:[Q(qb,{children:[Q(Xb,{children:[w(os,{children:"Engenharia"}),w(os,{children:"de"}),w(os,{children:"Computa\xE7\xE3o"})]}),w(Yb,{src:$b,alt:"Imagem de Computa\xE7\xE3o"})]}),Q(Gb,{children:[w(Kb,{children:"Carta de Servi\xE7os"}),w(Jb,{children:"Engenharia de Computa\xE7\xE3o"}),Q(Zb,{children:[Q(Jf,{children:[Q(Zf,{children:[w(Po,{src:Nb,alt:"Imagem Site"}),w(tp,{children:"Desenvolvimento de Websites"})]}),Q(ep,{children:[w(Po,{src:Kf,alt:"Seta"}),w(np,{children:"Desenvolvemos do zero um site pensado exclusivamente para atender as necessidades do seu neg\xF3cio. Utilizamos das ferramentas mais modernas do mercado para criar uma solu\xE7\xE3o \xFAnica que ir\xE1 alavancar a visibilidade do seu produto!"})]})]}),Q(Jf,{children:[Q(Zf,{children:[w(Po,{src:Ab,alt:"Imagem Sistemas"}),w(tp,{children:"Desenvolvimento de Sistemas Web"})]}),Q(ep,{children:[w(Po,{src:Kf,alt:"Seta"}),w(np,{children:"Com aux\xEDlio das mais completas linguagens de programa\xE7\xE3o, fornecemos aplicativos e sistemas pr\xF3prios para a sua empresa que ir\xE3o acelerar e auxiliar internamente no gerenciamento e desenvolvimento do seu neg\xF3cio."})]})]})]}),Q(e_,{children:[w(Qn,{src:Fb,alt:"ImagemHtml"}),w(Qn,{src:Ib,alt:"Imagemcss"}),w(Qn,{src:Hb,alt:"ImagemJS"}),w(Qn,{src:Wb,alt:"ImagemTS"}),w(Qn,{src:Ub,alt:"ImagemREACT"}),w(Qn,{src:Bb,alt:"ImagemStyled"})]})]}),w(o_,{}),w(i_,{children:w(r_,{onClick:()=>e("/contatos"),children:"Quer colocar um projeto em pr\xE1tica? \u2192"})}),w(n_,{children:w(gv,{carouselData:Rb.computingProjects})}),w(t_,{onClick:()=>window.scrollTo(0,0),src:yv,alt:"ScrollUp"})]})},l_=()=>Q(bm,{children:[w(rw,{}),Q($1,{children:[w(qn,{path:"/",element:w(GS,{})}),w(qn,{path:"/computacao",element:w(a_,{})}),w(qn,{path:"/mecanica",element:w(zb,{})}),w(qn,{path:"/quemSomos",element:w(uk,{})}),w(qn,{path:"/contatos",element:w($k,{})})]}),w(l1,{})]});function s_(){return w("div",{className:"App",children:w(I1,{basename:"/Site-Serra",children:w(l_,{})})})}as.createRoot(document.getElementById("root")).render(w(Ri.StrictMode,{children:w(s_,{})}));
